...
ddr_error_t ddr_4gb_2rank_x8_2gbx8_3200_pre_reset_init(uintptr_t base_addr_ctrl, bool ecc)
{
	...
	if (ecc) {
		...
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP0, 0x001f1f16);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP1, 0x003f1618);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP2, 0x01010100);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP3, 0x14161801);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP4, 0x00001f1f);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP5, 0x020f0202);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP6, 0x02020202);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP7, 0x00000f02);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP8, 0x00001801);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP9, 0x02020202);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP10, 0x02020202);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP11, 0x001f1f02);
	}
