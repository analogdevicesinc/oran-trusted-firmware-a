...
ddr_error_t ddr_2gb_2rank_x8_1gbx8_3200_pre_reset_init(uintptr_t base_addr_ctrl, bool ecc)
{
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_MSTR, 0x43041210);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_RFSHCTL1, 0x00b600a1);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_RFSHCTL3, 0x00000001);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_RFSHTMG, 0x00c30118);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ECCCFG0, 0x003f7f50);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_CRCPARCTL1, 0x00001000);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_INIT0, 0xc0010188);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_INIT1, 0x00010002);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_INIT3, 0x0c550001);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG0, 0x1611361a);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG1, 0x00050626);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG2, 0x080c0710);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG3, 0x0000400c);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG4, 0x0c04040d);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG5, 0x08080504);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG8, 0x0606120b);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG9, 0x0002020c);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG10, 0x000e0d05);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG11, 0x1a0b011f);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DFITMG0, 0x0493820b);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DFITMG1, 0x01070303);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DFITMG2, 0x0000130b);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP0, 0x00000017);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP3, 0x1f020202);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ODTCFG, 0x06000620);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_RFSHTMG, 0x00c30118);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_INIT3, 0x0c550001);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG0, 0x1611361a);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG1, 0x00050626);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG2, 0x080c0710);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG3, 0x0000400c);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG4, 0x0c04040d);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG5, 0x08080504);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG8, 0x0606120b);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG9, 0x0002020c);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG10, 0x000e0d05);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG11, 0x1a0b011f);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DFITMG0, 0x0493820b);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DFITMG1, 0x01070303);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DFITMG2, 0x0000130b);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DFITMG3, 0x00000008);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_ODTCFG, 0x06000620);
	...
	if (ecc) {
		...
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP0, 0x001f1f15);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP1, 0x003f0d0d);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP2, 0x01010100);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP3, 0x15151501);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP4, 0x00001f1f);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP5, 0x050f0303);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP6, 0x05050505);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP7, 0x00000f0f);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP8, 0x00000501);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP9, 0x03030303);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP10, 0x05050505);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP11, 0x001f1f05);
	}
