 ...
 *******************************************************************************
 */
ddr_error_t ddr_2gb_1rank_x16_1gbx8_3200pre_reset_init(uintptr_t base_addr_ctrl, bool ecc)
{
	...
	if (ecc) {
		...
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP7, 0x00000f0f);
		mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_ADDRMAP8, 0x00001701);
