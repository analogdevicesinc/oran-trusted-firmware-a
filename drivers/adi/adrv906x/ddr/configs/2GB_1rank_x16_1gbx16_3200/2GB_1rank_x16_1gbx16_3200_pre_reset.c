...
ddr_error_t ddr_2gb_1rank_x16_1gbx16_3200_pre_reset_init(uintptr_t base_addr_ctrl, bool ecc)
{
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_INIT3, 0x0c450001);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DRAMTMG2, 0x080a0510);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DFITMG0, 0x048f820b);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_DFITMG2, 0x00000f0b);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_INIT3, 0x0c450001);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DRAMTMG2, 0x080a0510);
	...
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DFITMG0, 0x048f820b);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DFITMG1, 0x02070303);
	mmio_write_32(base_addr_ctrl + DDR_UMCTL2_REGS_FREQ1_FREQ1_DFITMG2, 0x00000f0b);
