...
/* Pstate=0, Memclk=1600MHz, Programming CalUclkInfo::CalUClkTicksPer1uS to 0x625*/
	mmio_write_32((DDRPHYA_MASTER0_P0_MASTER0_P0_CALUCLKINFO_P0 + base_addr_phy), 0x625);
