...
static void adrv906x_spu_setup(void)
{
	...
	plat_spu_a55mmr_peripherals[SPU_A55MMR_PERIPH_SUBSYS_CFG_GPIO_AD9545].flags |= ADI_SPU_PERIPHERAL_FLAGS_NO_SSEC;
	plat_spu_a55mmr_peripherals[SPU_A55MMR_PERIPH_SUBSYS_CFG_GPIO_STREAM].flags |= ADI_SPU_PERIPHERAL_FLAGS_NO_SSEC;
	plat_spu_a55mmr_peripherals[SPU_A55MMR_PERIPH_SUBSYS_CFG_GPIO_REBOOT].flags |= ADI_SPU_PERIPHERAL_FLAGS_NO_SSEC;
