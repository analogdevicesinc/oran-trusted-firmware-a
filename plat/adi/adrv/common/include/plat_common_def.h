...
#ifdef RMA_CLI
#define BL1_RO_MAX_SIZE         UL(0x2D000)                                             /* 180KB max for BL1 RO */
#else
 ...
 */
#ifndef BL2_MAX_SIZE
#define BL2_MAX_SIZE                    UL(0x76000)                             /* 472 KB max for BL2 */
#endif
...
#else
#ifndef BL31_MAX_SIZE
#define BL31_MAX_SIZE                   UL(0x34000)                               /* 208 KB max for BL31 */
#endif
