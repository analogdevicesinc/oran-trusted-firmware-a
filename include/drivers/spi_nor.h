...
#define SPI_NOR_OP_WRDIS	0x04U	/* Write disable */
...
#define SPI_NOR_OP_ERASE_4SS	0x20U	/* 4-KB Sub sector erase*/
...
#define SPI_NOR_OP_PAGE_PROGRAM	0x02U	/* Write data bytes (low frequency) */
#define SPI_NOR_OP_WRITE_1_1_2	0xA2U	/* Write data bytes (Dual Output SPI) */
#define SPI_NOR_OP_WRITE_1_2_2	0xD2U	/* Write data bytes (Dual Output SPI) */
#define SPI_NOR_OP_WRITE_1_1_4	0x32U	/* Write data bytes (Quad Output SPI) */
#define SPI_NOR_OP_WRITE_1_4_4	0x38U	/* Write data bytes (Quad Output SPI) */
